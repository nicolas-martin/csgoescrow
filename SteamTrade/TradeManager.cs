...
namespace SteamTrade
{
    public class TradeManager
    {
        ...
        private Task<Inventories.Tf2Inventory> myInventoryTask;
        private Task<Inventories.Tf2Inventory> otherInventoryTask;
        ...
        public void InitializeTrade (SteamID me, SteamID other)
        {
            ...
            otherInventoryTask = Task.Factory.StartNew(() => Inventories.Tf2Inventory.FetchInventory(other.ConvertToUInt64(), ApiKey, SteamWeb));
            ...
            myInventoryTask = Task.Factory.StartNew(() => Inventories.Tf2Inventory.FetchInventory(me.ConvertToUInt64(), ApiKey, SteamWeb));
